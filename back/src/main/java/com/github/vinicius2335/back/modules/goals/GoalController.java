...
import com.github.vinicius2335.back.modules.goals.service.GetWeekSummaryService;
...
public class GoalController {
    ...
    private final GetWeekSummaryService getWeekSummaryService;
    ...
    @GetMapping("/summary")
    public ResponseEntity<Map<String, Object>> getWeekSummaryHandler() {
        return ResponseEntity.ok(getWeekSummaryService.execute());
    }
}
